...
ui_event_comp_ListItem(lv_event_t * e)
{
    ...
    if(event_code == LV_EVENT_FOCUSED) {
        ...
        lv_obj_set_style_text_opa(comp_ListItem[UI_COMP_LISTITEM_1], 255, LV_PART_MAIN | LV_STATE_DEFAULT);
        lv_obj_set_style_text_color(comp_ListItem[UI_COMP_LISTITEM_2],
                                    lv_color_hex(0x37F6FA),
                                    LV_PART_MAIN | LV_STATE_DEFAULT);
        lv_obj_set_style_text_opa(comp_ListItem[UI_COMP_LISTITEM_2], 255, LV_PART_MAIN | LV_STATE_DEFAULT);
        lv_obj_set_style_text_color(comp_ListItem[UI_COMP_LISTITEM_3],
                                    lv_color_hex(0x37F6FA),
                                    LV_PART_MAIN | LV_STATE_DEFAULT);
        lv_obj_set_style_text_opa(comp_ListItem[UI_COMP_LISTITEM_3], 255, LV_PART_MAIN | LV_STATE_DEFAULT);
        lv_obj_set_style_text_color(comp_ListItem[UI_COMP_LISTITEM_4],
                                    lv_color_hex(0x37F6FA),
                                    LV_PART_MAIN | LV_STATE_DEFAULT);
        lv_obj_set_style_text_opa(comp_ListItem[UI_COMP_LISTITEM_4], 255, LV_PART_MAIN | LV_STATE_DEFAULT);
    }
